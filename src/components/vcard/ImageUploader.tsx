...
import { ImagePlus, X, Check, ZoomIn, Edit2, Upload } from 'lucide-react';
...
const ImageUploader: React.FC<ImageUploaderProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      <div
        {...getRootProps()}
        className={`relative w-full h-full rounded-full border-2 border-dashed transition-colors cursor-pointer
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs text-center text-gray-600">
                {isDragActive ? (
                  ...
                  <p className="font-medium">Kattints</p>
                )}
              </div>
            </div>
          </div>
