...
const SEO: React.FC<SEOProps> = ({
  title = 'Digitális Névjegykártya Készítés | QR Kód Generálás | QRNevjegy.hu',
  description = 'Professzionális digitális névjegykártya készítés QR kóddal. Modern, környezetbarát és költséghatékony megoldás vállalkozásoknak. Azonnali megosztás és frissíthetőség.',
  ...
  return (
    <>
      ...
      <meta property="twitter:site" content="@qrnevjegy" />
      <meta property="twitter:creator" content="@qrnevjegy" />
