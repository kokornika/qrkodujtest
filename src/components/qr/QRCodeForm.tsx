...
const QRCodeForm: React.FC<QRCodeFormProps> = ({ options, onChange }) => {
  ...
  if (options.contentType === 'wifi') {
    return (
      <div className="space-y-6">
        ...
        <QRCodeCustomization options={options} onChange={onChange} />
      </div>
    );
  }
...
const QRCodeCustomization: React.FC<QRCodeFormProps> = ({ options, onChange }) => {
  return (
    <>
      <div>
