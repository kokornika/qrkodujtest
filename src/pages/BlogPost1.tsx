...
const BlogPost1 = () => {
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      <SEO 
        title="A digitális névjegykártyák 5 előnye | QRNevjegy Blog"
        description="Fedezze fel a digitális névjegykártyák 5 fő előnyét a hagyományos névjegyekkel szemben. Környezetbarát, költséghatékony és modern megoldás üzleti kapcsolataihoz."
        article={true}
      />
