...
import PhoneMockupSlideshow from '../components/home/PhoneMockupSlideshow';

const Guide = () => {
  return (
    <div className="min-h-screen bg-gray-50 pt-0">
      <SEO
        title="Hogyan Működik a Digitális Névjegykártya? | QRNevjegy"
        description="Útmutató a digitális névjegykártya elkészítéséhez és használatához QR kóddal."
      />
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Készítés és megosztás három lépésben
            </h2>
            <p className="text-lg text-gray-600">
              Pár perc alatt elkészül, pár másodperc alatt megosztható.
            </p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold">1. Készítse el a névjegyét</h3>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-medium mb-2">Adja meg az adatait</h4>
                        <p className="text-gray-600 text-sm">
                          Töltse ki nevét, pozícióját, cégét és elérhetőségeit — telefon, email, weboldal és cím.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-medium mb-2">Tegye személyessé a megjelenést</h4>
                        <p className="text-gray-600 text-sm">
                          Válassza ki a kártya színét, töltsön fel profilképet (opcionális) és adja hozzá a közösségi média linkjeit.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-medium mb-2">Megkapja a QR kódos digitális névjegykártyát</h4>
                        <p className="text-gray-600 text-sm">
                          Pillanatok alatt elkészül a digitális névjegye QR kóddal és saját megosztható linkkel.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold">2. Személyes találkozón</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold">3. Online megosztás</h3>
                </div>
